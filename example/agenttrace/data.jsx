...
const NODES = [
  ...
  },
  {
    ...
    temperature: null,
    prompt: {
      system: "Embed the query and retrieve the top-k support documents from the `kb_support` namespace (k=4, threshold=0.78).",
  ...
  },
  {
    ...
    temperature: 0.3,
    prompt: {
      system: "Synthesize the retrieved knowledge-base passages with the order context into a grounded brief the response agent can use. Cite doc ids. Do not fabricate tracking events.",
  ...
  },
  {
    ...
    temperature: null,
    prompt: {
      system: "Tool invocation: lookup_order(order_id). Returns live fulfillment record from the internal OMS.",
  ...
  },
  {
    ...
    error: {
      ...
      detail: "POST http://127.0.0.1:11434/api/generate — connection reset after 4.10s (ctx window 8192 exceeded by 142 tokens)"
    },
    prompt: {
      system: "You are a warm, concise support agent. Use ONLY grounded_facts. Offer reship OR refund. Max 90 words.",
